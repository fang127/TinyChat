...
inline ::PROTOBUF_NAMESPACE_ID::int32 ReplyFriendReq::_internal_replyuid() const {
  return replyuid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReplyFriendReq::replyuid() const {
  // @@protoc_insertion_point(field_get:message.ReplyFriendReq.replyUid)
  return _internal_replyuid();
}
inline void ReplyFriendReq::_internal_set_replyuid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  replyuid_ = value;
}
inline void ReplyFriendReq::set_replyuid(::PROTOBUF_NAMESPACE_ID::int32 value) {
