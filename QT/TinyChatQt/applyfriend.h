...
#include "UserData.h"
#include <QDialog>
// forward-declare the uic-generated class (actual generated type is
// Ui_ApplyFriend with a wrapper Ui::ApplyFriend). Using the underlying name
// avoids collisions between the `Ui::ApplyFriend` type and our `ApplyFriend`
// dialog class.
namespace Ui
{
class ApplyFriend;
