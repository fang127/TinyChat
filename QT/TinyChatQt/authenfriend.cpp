    ...
    ui(new Ui::AuthenFriend),_label_point(2,6)
{
    ...
    connect(ui->more_lb, &ClickedOnce::clicked, this, &AuthenFriend::ShowMoreLabel);
    InitTipLbs();
    //链接输入标签回车事件
    ...
    connect(ui->tip_lb, &ClickedOnce::clicked, this, &AuthenFriend::SlotAddFirendLabelByClickTip);
...
void AuthenFriend::addLabel(QString name)
{
    ...
    connect(tmplabel, &FriendLabel::sigClose, this, &AuthenFriend::SlotRemoveFriendLabel);
...
void AuthenFriend::SlotApplySure()
{
    ...
    //发送tcp请求给chat server
    emit TcpMgr::getInstance_()->sigSendData(ReqId::ID_AUTH_FRIEND_REQ, jsonData);
