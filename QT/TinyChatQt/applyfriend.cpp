    ...
    : QDialog(parent), ui(new Ui::ApplyFriend), _label_point(2, 6)
{
    ...
    this->setModal(true);
    ui->name_ed->setPlaceholderText(tr("happy"));
    ...
    connect(ui->more_lb, &ClickedOnce::clicked, this,
    ...
    connect(ui->tip_lb, &ClickedOnce::clicked, this,
...
void ApplyFriend::addLabel(QString name)
{
    ...
    {
        ui->gridWidget->setFixedHeight(_label_point.y() +
                                       tmplabel->height() * 2 + 2);
    }
}
...
void ApplyFriend::SlotApplySure()
{
    ...
    emit TcpMgr::getInstance_()
        -> sigSendData(ReqId::ID_ADD_FRIEND_REQ, jsonData);
    this->hide();
    deleteLater();
}
