    ...
    : QDialog(parent), ui(new Ui::RegisterDialog), countdown_(5)
{
    ...
    ui->confirmVisible->setState("unvisible","unvisible_hover","","visible",
                                    "visible_hover","");
    // 连接点击事件
    connect(ui->passVisible, &ClickedLabel::clicked, this, [this]()
    {
    ...
    connect(ui->confirmVisible, &ClickedLabel::clicked, this, [this]()
    {
    ...
    // 连接信号和槽
    connect(countdownTimer_, &QTimer::timeout, [this](){
        if(countdown_ == 0)
        {
